package com.ernesto.hashing.main;

import com.ernesto.hashinghowto.md5.HashingMD5;
import com.ernesto.hashinghowto.salt.Salting;
import com.ernesto.hashinghowto.sha.HashingSHA;
import com.ernesto.hashinghowto.sha.stronghash.PBKDF2;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            String value = "Innovation in Software and ErnestoDotNet";
